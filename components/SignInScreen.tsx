...
export function SignInScreen({
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      // Success! Auth state will be updated automatically by useAuth hook
      ...
      >
        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.iconSection}>
            ...
            >
              <Ionicons name="log-in" size={52} color="#ffffff" />
            </LinearGradient>
          </View>
          ...
          <View style={styles.descriptionSection}>
            <ThemedText style={styles.description}>
              Sign in to continue your voice-powered journey
            </ThemedText>
          </View>
